...
function socialIconProps({ className, ...props }: SocialIconProps) {
  return {
    ...
    className: className ?? "size-[21px] shrink-0",
    ...props,
  }
}

/**
 * Lucide does not ship trademarked brand icons.
 * Monochrome brand marks (Simple Icons-style paths) for recognizable IG / FB / LinkedIn.
 */
